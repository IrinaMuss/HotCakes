 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".cooks__slider")) new core(".cooks__slider", {
                ...
                navigation: {
                    prevEl: ".controll-slider__arrow-left",
                    nextEl: ".controll-slider__arrow-right"
                },
                on: {}
            });
        }
...
***************************************************************************** */
        ...
        function init() {
            let mapOptions = {
                zoom: 14,
                center: new google.maps.LatLng(54.9750665, 73.2415332),
                styles: [ {
            ...
            new google.maps.Marker({
                position: new google.maps.LatLng(54.975273064618335, 73.24869991270268),
                map,
                icon: {
                    url: "img/point.png",
